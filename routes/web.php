...
Route::get('backend', 'Auth\LoginController@showLoginForm')->middleware(['web', 'guest'])->name('login');
Route::post('backend', 'Auth\LoginController@login')->middleware(['web', 'guest']);
Route::post('logout', 'Auth\LoginController@logout')->middleware('web')->name('logout');
//Route::get('reset', 'Auth\MySecoureController@reset')->middleware('web');
//Route::post('reset', 'Auth\MySecoureController@resetCreateCode')->middleware('web')->name('reset');
//Route::get('resetpassword', 'Auth\MySecoureController@resetPasswordForm')->middleware('web');
//Route::get('sendcodeagain', 'Auth\MySecoureController@sendCodeAgain')->middleware('web');
//Route::post('resetpassword', 'Auth\MySecoureController@resetPassword')->middleware('web')->name('reset.password');
